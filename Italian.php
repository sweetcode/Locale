...
$locale['Global']['Selector']['Title'] = 'Italiano';
$locale['Global']['Header']['Title'] = "Potente sito di API progettato per i server Minecraft e siti web";
$locale['Global']['Header']['Description'] = "MCAPI fornisce molte API usate per i siti web correlati Minecraft. Tutte le API forniscono sia immagini o in JSON a seconda del tipo di API.";
$locale['Global']['Networks']['Title'] = "Networks che usano MCAPI";
$locale['Global']['Footer']['Copyright'] = "&copy; MCAPI | <a href=\"https://minecraft.net\">Minecraft</a> è copyright <a href=\"https://mojang.com\">Mojang</a> e non è affiliato con questo sito.";
$locale['Global']['Footer']['Issue'] = "Issue Tracker";
$locale['Global']['Footer']['Sponsored'] = "Sponsorizzato da MineSuperior &amp; MinePay";

// Homepage [Start]

$locale['Homepage']['Table']['Title'] = "Quali API sono offerti da MCAPI?";

// Table Headers

$locale['Homepage']['Table']['Headers']['API'] = "API";
$locale['Homepage']['Table']['Headers']['Description'] = "Descrizione";
$locale['Homepage']['Table']['Headers']['Path'] = "Percorso";
$locale['Homepage']['Table']['Headers']['Output'] = "Risultato";
$locale['Homepage']['Table']['Headers']['Example'] = "Esempio";
...
$locale['Homepage']['Table']['Body']['Name']['API'] = "API Nomi";
...
$locale['Homepage']['Table']['Body']['History']['API'] = "API Cronologia del nome";
...
$locale['Homepage']['Table']['Body']['Other']['API'] = "Altre API";
...
$locale['Pages']['History']['Title'] = "API Cronologia del nome";
$locale['Pages']['History']['Description'] = "In arrivo";

// MinecraftMarket API Page

$locale['Pages']['MinecraftMarket']['Title'] = "MinecraftMarket API";
$locale['Pages']['MinecraftMarket']['Description'] = "In arrivo";

// Buycraft API Page

$locale['Pages']['Buycraft']['Title'] = "Buycraft API";
$locale['Pages']['Buycraft']['Description'] = "Questa API è utilizzata per ottenere i dati su un negozio buycraft.";

// Other APIs Page

$locale['Pages']['Other']['Title'] = "Altre API";
$locale['Pages']['Other']['Description'] = "Queste API sono completamente casuali o non hanno bisogno di loro propria categoria per se stessi.";
